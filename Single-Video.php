    ...
    <div class="info">
        <div class="user">
            <div class="profile-pic">
                <img src="<?php echo "assets/images/profiles/". $profile_img; ?>">
            </div>
    ...
    <div id="post_info">
        <div class="post-content">
            ...
            <div class="reactions-wrapper">
                ...
                <?php include('check_like_statusVid.php'); ?>

                <?php if($reaction_status){ ?>
                    <button style="background:none;border:none;" onclick="return unlike();">
                        <i style="color:#fb3958;" class="icon fas fa-heart"></i>
                    </button>
                <?php } else { ?>
                    <button style="background:none;border:none;" onclick="return like();">
            ...
            <p class="post-time">
                <?php echo date("M,Y,d", strtotime($post['Date_Upload']));?>
            </p>

            <p class="post-time" style="color:#0b5ed7">
