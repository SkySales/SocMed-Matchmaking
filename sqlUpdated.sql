...
INSERT INTO `events` (`Event_ID`, `User_ID`, `Likes`, `Event_Poster`, `Caption`, `Event_Time`, `Event_Date`, `Invite_Link`, `HashTags`, `Date_Upload`) VALUES
	...
	(4, 17, 0, 'File_202604266141695.', 'ertyhrtgbgb', '16:19:00', '2026-04-11 00:00:00', 'https://chatgpt.com/c/69db0f63-e2a0-8321-9164-7f306039afa5', '#wow #Legit', '2026-04-26 10:16:16'),
	(5, 17, 0, 'File_202605123216979.png', 'sdasdw3123', '14:22:00', '3333-02-23 00:00:00', 'https://chatgpt.com/c/69db0f63-e2a0-8321-9164-7f306039afa5', '#tech #AI #machinelearning #conference #innovation', '2026-05-12 18:08:49');
...
CREATE TABLE IF NOT EXISTS `lobbies` (
  ...
  `Game_Name` varchar(100) DEFAULT 'Game',
  `Max_Players` int(11) DEFAULT 5,
  `Lobby_Status` enum('Waiting','In-Game','Full') DEFAULT 'Waiting',
  PRIMARY KEY (`Lobby_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Dumping data for table eventswave.lobbies: ~0 rows (approximately)
INSERT INTO `lobbies` (`Lobby_ID`, `Lobby_Name`, `Host_ID`, `Is_Private`, `Lobby_Code`, `Created_At`, `Game_Name`, `Max_Players`, `Lobby_Status`) VALUES
	(17, 'Test 1', 17, 1, '1359', '2026-05-13 16:34:53', 'CrossFire', 5, 'Waiting');
...
INSERT INTO `lobby_members` (`ID`, `Lobby_ID`, `User_ID`, `Joined_At`, `Team`, `Is_Ready`) VALUES
	(68, 16, 7, '2026-05-13 16:28:09', 'A', 0),
	(70, 17, 17, '2026-05-13 16:34:53', 'A', 0);

-- Dumping structure for table eventswave.lobby_messages
...
-- Dumping data for table eventswave.lobby_messages: ~2 rows (approximately)
INSERT INTO `lobby_messages` (`Message_ID`, `Lobby_ID`, `User_ID`, `Message`, `Sent_At`) VALUES
	(1, 14, 17, 'test', '2026-05-13 16:17:42'),
	(2, 14, 7, 'sino to', '2026-05-13 16:18:03');
...
INSERT INTO `posts` (`Post_ID`, `User_ID`, `Likes`, `Img_Path`, `Caption`, `HashTags`, `Date_Upload`) VALUES
	...
	(101, 17, 0, 'File_202604266549786.', 'fhrtertb', '', '2026-04-26 10:15:52'),
	(102, 17, 0, 'File_202604267681654.', 'rtbertbrtb', '#tech #AI #machinelearning #conference #innovation', '2026-04-26 10:16:00'),
	(103, 7, 0, 'File_202604264042114.', 'asdcasc', '#wow #Legit', '2026-04-26 10:16:39'),
	(104, 7, 1, 'File_202605048231871.pdf', 'fgverfgwercvwec', '#tech #AI #machinelearning #conference #innovation', '2026-05-04 13:48:04');
...
-- Dumping data for table eventswave.users: ~12 rows (approximately)
INSERT INTO `users` (`User_ID`, `FULL_NAME`, `USER_NAME`, `USER_TYPE`, `PASSWORD_S`, `EMAIL`, `IMAGE`, `FACEBOOK`, `WHATSAPP`, `BIO`, `FALLOWERS`, `FALLOWING`, `POSTS`, `is_tagged`) VALUES
	(7, 'Marc Amaba Avendano', 'Marcoooooo21', '1', '$2y$10$Wu8kG4OcQPDI4ToQ7mt4VuyZPHFxA4oRBlWjvXRNa0mD3glSDJyDy', 'skysales0321@gmail.com', 'Profile_202604123018193.png', 'hnfgnfghjdrh', 'sdgdhdfg', '213123123', 7, 7, 12, 1),
	(17, 'mabs3271', 'user_7363', '1', '$2y$10$fDk14y2NJbwLTGAFqQHvDObaTLZngKXy/2iOEmhzbLG.W782xm3IG', 'mabs3271@gmail.com', 'default.png', 'www.facebook.com', 'www.webwhatsapp.com', '0', 1, 4, 2, 1),
	(18, 'Torbu', 'Torbu_rat', '1', '$2y$10$QF3UXudrQscLj5WxgxnnaeH0t4jaaC83QIhXQKIGm3hoP4GvcXwe2', 'Torburatikolsal@gmail.com', 'default.png', 'www.facebook.com/Torburatikolsal', 'Torburatikolsal/12346455', 'Torburatikolsal', 3, 0, 0, 1),
	(19, 'skysales1321', 'user_7627', '1', '$2y$10$TZzfUioXFdMwY3YMMW34H.8R8b3Pk1fD9LBxRAKLXv3wyiBvob55K', 'skysales1321@gmail.com', 'default.png', 'www.facebook.com', 'www.webwhatsapp.com', '0', 2, 0, 0, 1),
	...
	(21, 'skysales3321', 'user_5638', '1', '$2y$10$xFOi28alYbj4K1j7RxlRY.GbGnTV5xa.iipbCA81wYeF8SkjrMEhq', 'skysales3321@gmail.com', 'default.png', 'www.facebook.com', 'www.webwhatsapp.com', '0', 0, 0, 0, 1),
	...
	(24, 'skysales0324', 'user_7525', '1', '$2y$10$h4kC6tq9JHeBGup/wTsp1efxBIzoFZjhucWd0dCvjId09YZboHl7O', 'skysales0324@gmail.com', 'default.png', 'www.facebook.com', 'www.webwhatsapp.com', '0', 0, 0, 0, 1),
	(25, 'mabs32731', 'user_3456', '1', '$2y$10$KOcUrm5KANc.l3wed8iyqelNlNP4QGvXR3tTeH.0yXxc2YWcEMrVu', 'mabs32731@gmail.com', 'default.png', 'www.facebook.com', 'www.webwhatsapp.com', '0', 0, 0, 0, 1),
	(26, 'skysales03212', 'user_9549', '1', '$2y$10$5cx.Rjs3yZ5uh6wiNNGAP.vrBfVQMxKEbxBFNy647DOG4x2nkTsXm', 'skysales03212@gmail.com', 'default.png', 'www.facebook.com', 'www.webwhatsapp.com', '0', 0, 0, 0, 1),
	(27, 'mabs32712', 'marc21111', '1', '$2y$10$FG8oC5sWBhQUoxqXt2FX2eKbHz7q7nzTFzpo87NAgJhT.7wX8Czuq', 'mabs32712@gmail.com', 'default.png', 'www.facebook.com', 'www.webwhatsapp.com', '0', 0, 0, 0, 1),
	(28, 'skysales022321', 'marc2121212', '1', '$2y$10$ECD80L6m4N3hgjGhUz6PFOwU5Jtu.84mUQ6/vOUnrMtIWG1TpIsvG', 'skysales022321@gmail.com', 'default.png', 'www.facebook.com', 'www.webwhatsapp.com', '0', 0, 0, 0, 1);
...
-- Dumping data for table eventswave.user_tags: ~51 rows (approximately)
